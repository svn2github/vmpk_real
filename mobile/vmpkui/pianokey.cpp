...
PianoKey::PianoKey(const QRectF &rect, const QBrush &brush, const int note, QGraphicsItem *parent)
...
PianoKey::PianoKey(const QRectF &rect, const bool black, const int note, QGraphicsItem *parent)
    : QGraphicsRectItem(rect, parent),
    m_pressed(false),
...
{
    static QSvgRenderer keyRenderer(QLatin1String(":/vpiano/blkey.svg"));
